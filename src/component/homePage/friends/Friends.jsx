            ...
            <div className='max-w-7xl mx-auto'>
                ...
                <div className='py-10 px-4'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
                        {
                            friends.map(friend => {
                                return <div key={friend.id} className='bg-white p-6 md:p-8 rounded-xl shadow hover:shadow-lg transition duration-300'>
                                    ...
                                    <div className='text-center space-y-2 mt-4'>
                                        ...
                                        <p className='bg-green-100 text-green-900 text-xs md:text-sm w-fit px-3 py-1 rounded-full uppercase font-semibold mx-auto'>{friend.tags[0]}</p>
